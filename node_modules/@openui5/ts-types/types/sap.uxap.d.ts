...
declare namespace sap {
  ...
  namespace uxap {
    ...
    interface $ObjectPageAccessibleLandmarkInfoSettings
       ...
       * is set.
       */
      navigationLabel?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
    ...
    interface $ObjectPageHeaderSettings extends sap.ui.core.$ControlSettings {
       ...
       */
      objectImageURI?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;

      /**
       * The text to be used for the Alt and Tooltip attribute of the image, supplied via the objectImageURI property
       */
      objectImageAlt?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
       ...
       */
      objectTitle?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;

      /**
       * The description of the object
       */
      objectSubtitle?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
    ...
    class AnchorBar extends sap.m.Toolbar {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         */
        oClassInfo?: sap.ClassInfo<T, sap.uxap.AnchorBar>,
        /**
    ...
    class BlockBase extends sap.ui.core.Control {
      ...
      fireViewInit(
         ...
         */
        mParameters?: sap.uxap.BlockBase$ViewInitEventParameters
      ): this;
      /**
    ...
    class BreadCrumbs extends sap.ui.core.Control {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.uxap.BreadCrumbs>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class HierarchicalSelect extends sap.m.Select {
      ...
      constructor(
         ...
         * Initial settings for the new control
         */
        mSettings?: sap.uxap.$HierarchicalSelectSettings
      );
      /**
       * Constructor for a new `HierarchicalSelect`.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.uxap.HierarchicalSelect>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class ModelMapping extends sap.ui.core.Element {
      ...
      constructor(
         ...
         * Initial settings for the new control
         */
        mSettings?: sap.uxap.$ModelMappingSettings
      );
      /**
       * Constructor for a new `ModelMapping`.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.uxap.ModelMapping>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class ObjectPageAccessibleLandmarkInfo extends sap.ui.core.Element {
      ...
      constructor(
         ...
         */
        mSettings?: sap.uxap.$ObjectPageAccessibleLandmarkInfoSettings
      );
      /**
       * Constructor for a new `sap.uxap.ObjectPageAccessibleLandmarkInfo` element.
       *
      ...
      implements sap.uxap.IHeaderContent
    {
      ...
      constructor(
         ...
         * Initial settings for the new control
         */
        mSettings?: sap.uxap.$ObjectPageDynamicHeaderContentSettings
      );
      /**
       * Constructor for a new `ObjectPageDynamicHeaderContent`.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.uxap.ObjectPageDynamicHeaderContent>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
      ...
      implements sap.uxap.IHeaderTitle
    {
      ...
      constructor(
         ...
         * Initial settings for the new control
         */
        mSettings?: sap.uxap.$ObjectPageDynamicHeaderTitleSettings
      );
      /**
       * Constructor for a new `ObjectPageDynamicHeaderTitle`.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.uxap.ObjectPageDynamicHeaderTitle>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
      ...
      implements sap.uxap.IHeaderTitle
    {
      ...
      fireMarkChangesPress(
         ...
         * Parameters to pass along with the event
         */
        mParameters?: sap.uxap.ObjectPageHeader$MarkChangesPressEventParameters
      ): this;
      /**
      ...
      fireMarkLockedPress(
         ...
         * Parameters to pass along with the event
         */
        mParameters?: sap.uxap.ObjectPageHeader$MarkLockedPressEventParameters
      ): this;
      /**
      ...
      fireTitleSelectorPress(
         ...
         * Parameters to pass along with the event
         */
        mParameters?: sap.uxap.ObjectPageHeader$TitleSelectorPressEventParameters
      ): this;
      /**
      ...
      setObjectImageBackgroundColor(
         ...
         */
        sObjectImageBackgroundColor?: sap.m.AvatarColor
      ): this;
      /**
      ...
      setObjectImageShape(
         ...
         */
        sObjectImageShape?: sap.m.AvatarShape
      ): this;
      /**
      ...
      implements sap.m.IOverflowToolbarContent
    {
      ...
      constructor(
         ...
         * Initial settings for the new control
         */
        mSettings?: sap.uxap.$ObjectPageHeaderActionButtonSettings
      );
      /**
       * Constructor for a new `ObjectPageHeaderActionButton`.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.uxap.ObjectPageHeaderActionButton>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
      ...
      implements sap.uxap.IHeaderContent
    {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.uxap.ObjectPageHeaderContent>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class ObjectPageHeaderLayoutData extends sap.ui.core.LayoutData {
      ...
      constructor(
         ...
         * Initial settings for the new control
         */
        mSettings?: sap.uxap.$ObjectPageHeaderLayoutDataSettings
      );
      /**
       * Constructor for a new `ObjectPageHeaderLayoutData`.
       *
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.uxap.ObjectPageHeaderLayoutData>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class ObjectPageLayout extends sap.ui.core.Control {
      ...
      constructor(
         ...
         * Initial settings for the new control
         */
        mSettings?: sap.uxap.$ObjectPageLayoutSettings
      );
      /**
       * Constructor for a new `ObjectPageLayout`.
       *
      ...
      fireHeaderContentPinnedStateChange(
         ...
         * Parameters to pass along with the event
         */
        mParameters?: sap.uxap.ObjectPageLayout$HeaderContentPinnedStateChangeEventParameters
      ): this;
      /**
      ...
      fireNavigate(
         ...
         * Parameters to pass along with the event
         */
        mParameters?: sap.uxap.ObjectPageLayout$NavigateEventParameters
      ): this;
      /**
      ...
      fireSectionChange(
         ...
         * Parameters to pass along with the event
         */
        mParameters?: sap.uxap.ObjectPageLayout$SectionChangeEventParameters
      ): this;
      /**
      ...
      fireSubSectionVisibilityChange(
         ...
         * Parameters to pass along with the event
         */
        mParameters?: sap.uxap.ObjectPageLayout$SubSectionVisibilityChangeEventParameters
      ): this;
      /**
      ...
      fireToggleAnchorBar(
         ...
         * Parameters to pass along with the event
         */
        mParameters?: sap.uxap.ObjectPageLayout$ToggleAnchorBarEventParameters
      ): this;
      /**
    ...
    class ObjectPageLazyLoader extends sap.ui.core.Element {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.uxap.ObjectPageLazyLoader>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
    ...
    class ObjectPageSection extends sap.uxap.ObjectPageSectionBase {
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.uxap.ObjectPageSection>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
     ...
     * @since 1.26
     */
    abstract class ObjectPageSectionBase extends sap.ui.core.Control {
      /**
      ...
      static extend<T extends Record<string, unknown>>(
         ...
         * Object literal with information about the class
         */
        oClassInfo?: sap.ClassInfo<T, sap.uxap.ObjectPageSectionBase>,
        /**
         * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
         * used by this class
         */
     ...
     */
    type ObjectPageLayout$HeaderContentPinnedStateChangeEvent =
      sap.ui.base.Event<
