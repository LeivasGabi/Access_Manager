  ...
  namespace ui {
    ...
    namespace ux3 {
      ...
      interface $CollectionSettings extends sap.ui.core.$ElementSettings {
         ...
         */
        selectedItems?: Array<sap.ui.core.Item | string>;
      ...
      interface $ExactSettings extends sap.ui.core.$ControlSettings {
         ...
         */
        resultText?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      interface $ExactListSettings extends sap.ui.core.$ControlSettings {
         ...
         */
        topTitle?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
         ...
         */
        data?: sap.ui.ux3.ExactAttribute | string;
      ...
      interface $FeedSettings extends sap.ui.core.$ControlSettings {
         ...
         */
        feederSender?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      interface $FeedChunkSettings extends sap.ui.core.$ControlSettings {
         ...
         * Sender of the chunk
         */
        sender?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;

        /**
         * Format is ISO 8601 YYYY-MM-DDThh:mm:ss.sZ, Z meaning the time is in UTC time zone
         */
        timestamp?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      interface $NavigationBarSettings extends sap.ui.core.$ControlSettings {
         ...
         */
        associatedItems?: Array<sap.ui.ux3.NavigationItem | string>;
      ...
      interface $QuickViewSettings extends sap.ui.commons.$CalloutBaseSettings {
         ...
         */
        firstTitle?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;

        /**
         * URI to Thing Inspector
         */
        firstTitleHref?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      interface $ShellSettings extends sap.ui.core.$ControlSettings {
         ...
         */
        appTitle?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
         ...
         */
        appIconTooltip?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
      ...
      class CollectionInspector extends sap.ui.core.Control {
         ...
         * or `null`.
         */
        getSelectedCollection(): sap.ui.core.ID | null;
        /**
        ...
        implements sap.ui.ux3.DataSetView
      {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.ui.ux3.DataSetSimpleView>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class ExactBrowser extends sap.ui.core.Control {
         ...
         * or `null`.
         */
        getFollowUpControl(): sap.ui.core.ID | null;
        /**
      ...
      class ExactList extends sap.ui.core.Control {
         ...
         * takes care to fill this aggregation according to the given ExactAttribute.
         */
        getSubLists(): sap.ui.ux3.ExactList[];
        /**
         ...
         * @returns An array of the removed elements (might be empty)
         */
        removeAllSubLists(): sap.ui.ux3.ExactList[];
        /**
      ...
      class FacetFilter extends sap.ui.core.Control {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.ui.ux3.FacetFilter>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class NavigationItem extends sap.ui.core.Item {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.ui.ux3.NavigationItem>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class OverlayContainer extends sap.ui.ux3.Overlay {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.ui.ux3.OverlayContainer>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class OverlayDialog extends sap.ui.ux3.Overlay {
        ...
        static extend<T extends Record<string, unknown>>(
           ...
           * Object literal with information about the class
           */
          oClassInfo?: sap.ClassInfo<T, sap.ui.ux3.OverlayDialog>,
          /**
           * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
           * used by this class
           */
      ...
      class Shell extends sap.ui.core.Control {
         ...
         * or `null`.
         */
        getSelectedWorksetItem(): sap.ui.core.ID | null;
        /**
      ...
      class ThingInspector extends sap.ui.ux3.Overlay {
         ...
         * or `null`.
         */
        getSelectedFacet(): sap.ui.core.ID | null;
        /**
         * Gets current value of property {@link #getType type}.
         *
         * Thing type
