    ...
    namespace webc {
      ...
      namespace fiori {
        ...
        interface $FlexibleColumnLayoutSettings
           ...
           */
          endColumn?: sap.ui.core.Control;

          /**
           * Defines the content in the middle column.
           */
          midColumn?: sap.ui.core.Control;

          /**
           * Defines the content in the start column.
           */
          startColumn?: sap.ui.core.Control;
        ...
        interface $ProductSwitchItemSettings
           ...
           */
          targetSrc?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
        ...
        interface $ShellBarSettings
           ...
           */
          primaryTitle?: string | sap.ui.base.ManagedObject.PropertyBindingInfo;
           ...
           */
          startButton?: sap.ui.webc.main.IButton;
          ...
          implements sap.ui.webc.fiori.IBar
        {
          ...
          setDesign(
             ...
             */
            sDesign?: sap.ui.webc.fiori.BarDesign
          ): this;
          /**
        ...
        class BarcodeScannerDialog extends sap.ui.core.webc.WebComponent {
          ...
          fireScanError(
             ...
             */
            mParameters?: sap.ui.webc.fiori.BarcodeScannerDialog$ScanErrorEventParameters
          ): this;
          /**
          ...
          fireScanSuccess(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.BarcodeScannerDialog$ScanSuccessEventParameters
          ): this;
          /**
        ...
        class DynamicSideContent extends sap.ui.core.webc.WebComponent {
          ...
          fireLayoutChange(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.DynamicSideContent$LayoutChangeEventParameters
          ): this;
          /**
        ...
        class FlexibleColumnLayout extends sap.ui.core.webc.WebComponent {
          ...
          fireLayoutChange(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.FlexibleColumnLayout$LayoutChangeEventParameters
          ): this;
          /**
        ...
        class MediaGallery extends sap.ui.core.webc.WebComponent {
          ...
          fireSelectionChange(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.MediaGallery$SelectionChangeEventParameters
          ): this;
          /**
          ...
          implements sap.ui.webc.fiori.INotificationAction
        {
          ...
          constructor(
             ...
             * Initial settings for the new control
             */
            mSettings?: sap.ui.webc.fiori.$NotificationActionSettings
          );
          /**
           * Constructor for a new `NotificationAction`.
           *
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             * Object literal with information about the class
             */
            oClassInfo?: sap.ClassInfo<T, sap.ui.webc.fiori.NotificationAction>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
             * used by this class
             */
          ...
          implements sap.ui.webc.main.IListItem
        {
          ...
          addAction(
             ...
             * The action to add; if empty, nothing is inserted
             */
            oAction: sap.ui.webc.fiori.INotificationAction
          ): this;
          /**
           * Adds some item to the aggregation {@link #getItems items}.
           *
          ...
          addItem(
             ...
             * The item to add; if empty, nothing is inserted
             */
            oItem: sap.ui.webc.fiori.INotificationListItem
          ): this;
          /**
          ...
          setPriority(
             ...
             */
            sPriority?: sap.ui.webc.main.Priority
          ): this;
          /**
            ...
            sap.ui.webc.main.IListItem
        {
          ...
          setAvatar(
             ...
             * The avatar to set
             */
            oAvatar: sap.ui.webc.main.IAvatar
          ): this;
          /**
           * Sets a new value for property {@link #getBusy busy}.
           *
        ...
        class Page extends sap.ui.core.webc.WebComponent {
          ...
          setBackgroundDesign(
             ...
             */
            sBackgroundDesign?: sap.ui.webc.fiori.PageBackgroundDesign
          ): this;
          /**
        ...
        class ProductSwitch extends sap.ui.core.webc.WebComponent {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             * Object literal with information about the class
             */
            oClassInfo?: sap.ClassInfo<T, sap.ui.webc.fiori.ProductSwitch>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
             * used by this class
             */
        ...
        class ShellBar extends sap.ui.core.webc.WebComponent {
          ...
          addItem(
             ...
             * The item to add; if empty, nothing is inserted
             */
            oItem: sap.ui.webc.fiori.IShellBarItem
          ): this;
          /**
          ...
          addMenuItem(
             ...
             */
            oMenuItem: sap.ui.webc.main.IListItem
          ): this;
          /**
          ...
          fireCoPilotClick(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.ShellBar$CoPilotClickEventParameters
          ): this;
          /**
          ...
          fireLogoClick(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.ShellBar$LogoClickEventParameters
          ): this;
          /**
          ...
          fireMenuItemClick(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.ShellBar$MenuItemClickEventParameters
          ): this;
          /**
          ...
          fireNotificationsClick(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.ShellBar$NotificationsClickEventParameters
          ): boolean;
          /**
          ...
          fireProductSwitchClick(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.ShellBar$ProductSwitchClickEventParameters
          ): boolean;
          /**
          ...
          setLogo(
             ...
             * The logo to set
             */
            oLogo: sap.ui.webc.main.IAvatar
          ): this;
          /**
          ...
          setProfile(
             ...
             * The profile to set
             */
            oProfile: sap.ui.webc.main.IAvatar
          ): this;
          /**
          ...
          setSearchField(
             ...
             */
            oSearchField: sap.ui.webc.main.IInput
          ): this;
          /**
          ...
          setStartButton(
             ...
             */
            oStartButton: sap.ui.webc.main.IButton
          ): this;
        }
        /**
         * @since 1.92.0
          ...
          implements sap.ui.webc.fiori.IShellBarItem
        {
          ...
          fireClick(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.ShellBarItem$ClickEventParameters
          ): boolean;
          /**
        ...
        class SideNavigation extends sap.ui.core.webc.WebComponent {
          ...
          addFixedItem(
             ...
             */
            oFixedItem: sap.ui.webc.fiori.ISideNavigationItem
          ): this;
          /**
          ...
          addItem(
             ...
             * The item to add; if empty, nothing is inserted
             */
            oItem: sap.ui.webc.fiori.ISideNavigationItem
          ): this;
          /**
           * Attaches event handler `fnFunction` to the {@link #event:selectionChange selectionChange} event of this
          ...
          fireSelectionChange(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.SideNavigation$SelectionChangeEventParameters
          ): boolean;
          /**
           * Gets current value of property {@link #getCollapsed collapsed}.
           *
          ...
          implements sap.ui.webc.fiori.ISideNavigationItem
        {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             * Object literal with information about the class
             */
            oClassInfo?: sap.ClassInfo<T, sap.ui.webc.fiori.SideNavigationItem>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
             * used by this class
             */
        ...
        class UploadCollection extends sap.ui.core.webc.WebComponent {
          ...
          addItem(
             ...
             * The item to add; if empty, nothing is inserted
             */
            oItem: sap.ui.webc.fiori.IUploadCollectionItem
          ): this;
          /**
          ...
          fireDrop(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.UploadCollection$DropEventParameters
          ): this;
          /**
          ...
          fireItemDelete(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.UploadCollection$ItemDeleteEventParameters
          ): this;
          /**
           * Fires event {@link #event:selectionChange selectionChange} to attached listeners.
           *
          ...
          fireSelectionChange(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.UploadCollection$SelectionChangeEventParameters
          ): this;
          /**
           * Gets current value of property {@link #getAccessibleName accessibleName}.
           *
          ...
          setMode(
             ...
             */
            sMode?: sap.ui.webc.main.ListMode
          ): this;
          /**
        ...
        class ViewSettingsDialog extends sap.ui.core.webc.WebComponent {
          ...
          fireCancel(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.ViewSettingsDialog$CancelEventParameters
          ): this;
          /**
          ...
          fireConfirm(
             ...
             * Parameters to pass along with the event
             */
            mParameters?: sap.ui.webc.fiori.ViewSettingsDialog$ConfirmEventParameters
          ): this;
          /**
        ...
        class Wizard extends sap.ui.core.webc.WebComponent {
          ...
          addStep(
             ...
             */
            oStep: sap.ui.webc.fiori.IWizardStep
          ): this;
          /**
          ...
          implements sap.ui.webc.fiori.IWizardStep
        {
          ...
          static extend<T extends Record<string, unknown>>(
             ...
             * Object literal with information about the class
             */
            oClassInfo?: sap.ClassInfo<T, sap.ui.webc.fiori.WizardStep>,
            /**
             * Constructor function for the metadata object; if not given, it defaults to the metadata implementation
             * used by this class
             */
